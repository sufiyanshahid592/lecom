                                    ...
                                    <form class="register-form" method="post" action="{{url('register-process')}}">
                                        ...
                                        <!-- <div class="payment_option mb-50">
                                            <div class="custome-radio">
                                                <input class="form-check-input" required="" type="radio" name="user_type" id="exampleRadios3" value="customer" />
                                            ...
                                            <div class="custome-radio">
                                                <input class="form-check-input" required="" type="radio" name="user_type" id="exampleRadios4" value="vendor" />
                                        ...
                                        <div class="login_footer form-group mb-50">
                                            ...
                                            <a href="{{url('page-privacy-policy')}}"><i class="fi-rs-book-alt mr-5 text-muted"></i>Lean more</a>
                                        </div>
                        ...
                        <div class="col-lg-6 pr-30 d-none d-lg-block">
                            <div class="card-login mt-115">
                                <a href="#" class="social-login facebook-login">
                                    <img src="{{url('assets/user/imgs/theme/icons/logo-facebook.svg')}}" alt="" />
                                    <span>Continue with Facebook</span>
                                </a>
                                <a href="#" class="social-login google-login">
                                    <img src="{{url('assets/user/imgs/theme/icons/logo-google.svg')}}" alt="" />
