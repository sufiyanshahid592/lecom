                ...
                <div class="col-lg-9 m-auto">
                    <div class="single-page pt-50 pr-30">
                                    ...
                                    <div class="single-header-meta">
                                        <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                            <a class="author-avatar" href="#">
                                                <img class="img-circle" src="{{url('assets/user/imgs/blog/author-1.png')}}" alt="">
                                            </a>
                                        ...
                                        <div class="social-icons single-share">
                                            <ul class="text-grey-5 d-inline-block">
                                                <li class="mr-5"><a href="#"><img src="{{url('assets/user/imgs/theme/icons/icon-bookmark.svg')}}" alt=""></a></li>
                                                <li><a href="#"><img src="{{url('assets/user/imgs/theme/icons/icon-heart-2.svg')}}" alt=""></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <figure class="single-thumbnail">
                            <img width="100%" src="{{url('assets/images/'.$get_blog_detail_by_slug[0]->blog_image)}}" alt="">
                        </figure>
